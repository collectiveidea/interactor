...
# module Helpers
#   def usage
#     @estimate_template_id = ContextualEmailTemplateId.instance(tenant: @tenant, type: Estimate)
#     @order_template_id    = ContextualEmailTemplateId.instance(tenant: @tenant, type: Order)
#     @contact_template_id  = ContextualEmailTemplateId.instance(tenant: @tenant, type: Contact)
#   end
